<footer style="background-color: #212529" class="p-4  no-print sm:p-6 ">
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400 pl-0">
                        <li class="mb-4">
                            <a href="#" class="unstyled-link">Privacy Policy</a>
                        </li>
                        <li>
                            <a href="#" class="unstyled-link">Terms &amp; Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/"
                    class="unstyled-link">Threads and Trends™</a>. All Rights Reserved.
            </span>
