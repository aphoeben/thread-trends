...
@section('content')
    ...
    <title>Contact</title>
                ...
                <body>
                    <img class="contactus" src="{{ URL::to('/images/-insertpic') }}">
                    <h1>Contact Us</h1>
                    <p>If you have any questions, comments, or feedback, please don't hesitate to get in touch with us.<br>
        ...
        <button type="submit" class="btn btn-primary">Submit</button>
                    ...
                    <div class="icon-contact">
                        ...
                        </svg><p class="icon-text">+639876543210</p></span>
                        ...
                        </svg><p class="icon-text">threadsntrends@gmail.com</p></span>
                        ...
                        </svg><p class="icon-text">España Blvd, Sampaloc, Metro Manila</p></span>
                    </div>
                </body>
                ...
                <footer>
                    <div class="footer-content">
                        <p>© 2023 Threads & Trends | All rights reserved.</p>
                    </div>
                </footer>
@endsection